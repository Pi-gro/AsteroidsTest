...
var ASM_CONSTS = {
 ...
 138176: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 138259: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 138328: () => { return window.innerWidth; },  
 138358: () => { return window.innerHeight; }
};
